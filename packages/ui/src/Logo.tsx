...
/**
 * Marchio quadrato in verde smeraldo con un glifo bianco a due tratti
 * (brief "Vicinato", CLAUDE.md §19). SVG via react-native-svg, così il logo
 * resta portabile su mobile anche se oggi lo consuma solo apps/web
