...
/**
 * I 6 stati di pipeline mostrati in `/dashboard/richieste` — derivati
 ...
 */
export type RequestStage = "da_quotare" | "in_attesa" | "modifica_richiesta" | "accettata" | "completata" | "scaduta" | "chiusa";
